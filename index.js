...
function compraCamisas() {
    ...
    if (number > 5) {
        resultElement.textContent = "La compra se debe pagarse con tarjeta de credito porfavor."

    } else if (number <= 5 && number > 0) {
        resultElement.textContent = "La compra se debe pagarse en efectivo porfavor."
    } else {
